...
int main(int argc, char *argv[])
{
	...
	" -l left\t\tSet primary colour for left area\n\t\t\t(se bellow for available colours).\n"
	" -c center\t\tSet primary colour for center area.\n"
	" -r right\t\tSet primary colour for right area.\n"
	" -g logo\t\tSet primary colour for the SteelSeries logo.\n"
	" -i front-left\t\tSet primary colour for front left area.\n"
	" -d front-right\t\tSet primary colour for front right area.\n"
	" -t touchpad\t\tSet primary colour for the touchpad.\n"
	" -h help\t\tThis help.\n\n"
